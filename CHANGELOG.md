...
- **`docs/index.html`**: Fixed install version (v0.2.0 → v0.4.2), fixed example count (8 → 12)
- **`docs/manifesto.html`**: Removed unimplemented Rust and HTMX from target claims, fixed "active development" → "early development" to match source MANIFESTO.md
- **`docs/HUMAN_LANG_SPEC.md`**: Fixed deploy targets — removed Vercel (planned), replaced with Docker, AWS (Terraform), GCP (Terraform)
