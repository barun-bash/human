...
var HUMAN_STATUS = "Language spec, LLM prompt, 13 examples, 16 generators, 38 REPL commands, 1,200+ tests, Figma design import, OpenAPI import, git workflow. 85+ files per build.";
