...
func GenerateReactTheme(theme *ir.Theme) map[string]string {
	...
	case "shadcn":
		files["tailwind.config.js"] = GenerateTailwindConfig(theme, tokens)
...
func GenerateTailwindConfig(theme *ir.Theme, tokens map[string]string) string {
	var b strings.Builder

	b.WriteString("// Generated by Human compiler — do not edit\n\n")
	b.WriteString("/** @type {import('tailwindcss').Config} */\n")
	b.WriteString("export default {\n")
	b.WriteString("  content: ['./index.html', './src/**/*.{js,ts,jsx,tsx,vue,svelte}'],\n")
